...
function loadHtml5Gallery(u) {
        ...
        k = x.drag = {
            ...
            hijack: function (b, e, a,
                ...
                if (a) {
                    ...
                    a.results = [];
                    do
                        if ((w = a.interactions[g]) && !("dragend" !== e && w.cancelled)) r = k.properties(b, a, w), w.results = [], m(d || w[j] || a.droppable).each(function (c, d) {
                            r.target = d;
                            l = t.handle ? d ? t.handle.call(d, b, r) : null : d ? t.dispatch.call(d, b, r) : null;
    ...
    n.fn.addHTML5VideoControls = function (b, e, a, c, d, h, f, j, l) {
        var g = "ontouchstart" in window,
            ...
            F = n(this).data("src"),
            q = n(this);
        q.get(0).removeAttribute("controls");
        ...
        q.on("touch click mousemove mouseenter", function () {
            x = !0
        });
        c || setInterval(function () {
            x && (v.show(), x = !1, clearTimeout(t), t = setTimeout(function () {
                q.get(0).paused || v.fadeOut()
            }, 5E3))
        }, 250);
        ...
        C.css({
            ...
            q.get(0).currentTime = a * q.get(0).duration / C.width();
            C.on(r, function (a) {
                a = (g ? a.originalEvent.touches[0] : a).pageX - C.offset().left;
                O.css({
                    width: a
        ...
        if (y.get(0).requestFullscreen || y.get(0).webkitRequestFullScreen || y.get(0).mozRequestFullScreen || y.get(0).webkitEnterFullScreen || y.get(0).msRequestFullscreen) {
            var H = function (a) {
                f ? a ? (q.get(0).setAttribute("controls", "controls"), j && q.get(0).setAttribute("controlsList", "nodownload")) : q.get(0).removeAttribute("controls") :
            ...
            n(".html5boxFullscreen", v).css({
                ...
                (s = !s) ? (f && (q.get(0).setAttribute("controls", "controls"), j && q.get(0).setAttribute("controlsList", "nodownload")), y.get(0).requestFullscreen ? y.get(0).requestFullscreen() : y.get(0).webkitRequestFullScreen ? y.get(0).webkitRequestFullScreen() : y.get(0).mozRequestFullScreen ? y.get(0).mozRequestFullScreen() : y.get(0).webkitEnterFullScreen && y.get(0).webkitEnterFullScreen(), y.get(0).msRequestFullscreen && y.get(0).msRequestFullscreen()) : document.cancelFullScreen ? document.cancelFullScreen() :
        ...
        if (A) n(".html5boxHD", v).css({
            ...
            function () {
                ...
                e.isHd = D;
                var a = q.get(0).isPaused;
                q.get(0).setAttribute("src", (D ? A : F) + "#t=" + q.get(0).currentTime);
                a ? q.get(0).pause() : q.get(0).play()
            });
        q.get(0).volume = h;
        var Y = 0 == h ? 1 : h;
        a = q.get(0).volume;
        q.get(0).volume = a / 2 + 0.1;
        if (q.get(0).volume === a / 2 + 0.1) {
            q.get(0).volume = a;
        ...
        k = function () {
            var a = q.get(0).currentTime;
            if (a) {
                U.text(aa(a));
                var b = q.get(0).duration;
                if (b) {
                    G.text(aa(b));
                    var c = C.width(),
                        a = Math.round(c * a / b);
        ...
        m = function () {
            if (q.get(0).buffered && 0 < q.get(0).buffered.length && !isNaN(q.get(0).buffered.end(0)) && !isNaN(q.get(0).duration)) {
                var a = C.width();
                P.css({
                    width: Math.round(a * q.get(0).buffered.end(0) / q.get(0).duration)
                })
            }
        };
        try {
            q.on("play", function () {
                d || B.hide();
                c || (L.hide(), p.show())
            }), q.on("pause", b), q.on("ended", w), q.on("timeupdate", k), q.on("progress", m)
        } catch (ba) {}
    };
    var b = jQuery,
        F = 0;
        ...
        e.prototype = {
            ...
            resizeStyleVertical: function () {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    this.options.responsivefullscreen &&
                        0 < this.container.parent().height() ? (this.options.containerHeight = this.container.parent().height(), this.options.totalHeight = this.options.containerHeight, this.options.height = "bottom" == this.options.carouselposition ? this.options.totalHeight - (this.options.headerHeight + 2 * this.options.padding + this.options.carouselheight) : this.options.totalHeight - (this.options.headerHeight + 2 * this.options.padding)) : (this.options.height = Math.round(this.options.width * this.options.originalHeight / this.options.originalWidth), this.options.totalHeight =
                            "bottom" == this.options.carouselposition ? this.options.height + this.options.headerHeight + 2 * this.options.padding + this.options.carouselmargin + this.options.carouselHeight : this.options.height + this.options.headerHeight + 2 * this.options.padding, this.options.containerHeight = this.options.totalHeight);
                    this.container.css({
                    ...
                    if (this.options.showcarousel)
                        if ("bottom" == this.options.carouselposition) {
                            ...
                            this.options.carouselSlider = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)) <
                            ...
                            this.options.isMobile ? (b(".html5gallery-car-left-" +
                                this.id).css({
                            ...
                            this.options.thumbshowtitle && b("head").append("<style type='text/css' data-creator='html5gallery'>.html5gallery-tn-title-" +
                                ...
                                20, this.options.width -= 20, this.options.height = Math.round(this.options.width * this.options.originalHeight / this.options.originalWidth), this.options.boxWidth = this.options.width, this.options.slideshadow && (this.options.boxWidth += 8)), "left" == this.options.carouselposition ? (this.options.boxLeft = this.options.padding + this.options.carouselWidth + this.options.carouselmargin, this.options.carouselLeft = this.options.padding) : this.options.carouselLeft = this.options.padding + this.options.width + this.options.carouselmargin,
                    ...
                    if (1 == a || this.showingPoster) {
                    ...
                    } else if (12 == a || 5 == a || 6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) d = this.elemArray[this.curElem][10], c = this.elemArray[this.curElem][11], this.isFullscreen ?
                        (a = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : this.fullscreenWidth, e = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : this.fullscreenHeight, e = Math.min(a / d, e / c), e = 1 < e ? 1 : e, d = Math.round(e * d), c = Math.round(e * c), this.adjustFullscreen(d, c, !0)) : (d = this.options.width, c = this.options.height), b(".html5gallery-elem-" + this.id).css({
                            ...
                            width: d + "px",
                            height: c + "px"
                        }), b("#html5gallery-elem-video-" + this.id).attr("width", d), b("#html5gallery-elem-video-" + this.id).attr("height", c), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("width", d), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("height",
                            c), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("width", d), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", c), b(".html5gallery-elem-iframe-" + this.id).css({
                            width: d + "px",
                            height: c + "px"
                        }), b(".html5gallery-elem-iframe-" + this.id).find("iframe").attr("width", d), b(".html5gallery-elem-iframe-" + this.id).find("iframe").attr("height", c);
                    e = d = 0;
                    "bottom" == this.options.headerpos && (d = this.options.titleoverlay ? this.options.height - this.options.titleheight : this.options.height, e = this.options.titleoverlay ?
                    ...
                    this.options.showcarousel && (b(".html5gallery-car-" + this.id).css({
                        ...
                        }), this.options.thumbShowNum = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)), 1 > this.options.thumbShowNum && (this.options.thumbShowNum = 1), this.options.thumbMaskHeight =
                        this.options.thumbShowNum * this.options.thumbheight + (this.options.thumbShowNum - 1) * this.options.thumbgap, this.options.thumbTotalHeight = this.elemArray.length * this.options.thumbheight + (this.elemArray.length - 1) * this.options.thumbgap, this.options.carouselSlider && (this.options.carouselSliderMin = 0, this.options.carouselSliderMax = this.options.thumbMaskHeight - 54, b(".html5gallery-car-slider-bar-" + this.id).css({
                            ...
                            height: String(this.options.thumbMaskHeight -
                                32) + "px"
                ...
                for (var d = 0; d < this.elemArray.length; d++) {
                    ...
                    b(e).on("load", function () {
                        ...
                        a.options.carouselmultirows && "samecolumn" == a.options.thumbresponsive ? b("#html5gallery-tn-" + a.id + "-" + this.data, c).append("<div class='html5gallery-tn-img-" + a.id + "'" + g + " style='position:relative;width:" + String(a.options.thumbimagewidth + 2 * a.options.thumbimageborder) + "px;height:" + String(a.options.thumbimageheight + 2 * a.options.thumbimageborder) + "px;'><div style='display:block; overflow:hidden; position:absolute; width:" + a.options.thumbimagewidth + "px;height:" + a.options.thumbimageheight + "px; top:" +
                            a.options.thumbimageborder + "px; left:" + a.options.thumbimageborder + "px;'><img alt='" + a.html2Text(a.elemArray[this.data][25]) + "'" + (a.options.addimgtitle ? " title='" + a.html2Text(a.elemArray[this.data][7]) + "'" : "") + " data-originalwidth=" + this.width + " data-originalheight=" + this.height + " class='html5gallery-tn-image-" + a.id + "'" + g + " style='border:none; padding:0px; margin:0px; max-width:100%; max-height:none; width:" + e + "px; height:" + d + "px;' src='" + a.elemArray[this.data][1] + "' /></div>" + h + "</div><div class='html5gallery-tn-title-" +
                            ...
                            a.options.thumbimageborder + "px; left:" + a.options.thumbimageborder + "px;'><img alt='" + a.html2Text(a.elemArray[this.data][25]) + "'" + (a.options.addimgtitle ? " title='" + a.html2Text(a.elemArray[this.data][7]) + "'" : "") + " data-originalwidth=" + this.width + " data-originalheight=" + this.height + " class='html5gallery-tn-image-" + a.id + "'" + g + " style='border:none; padding:0px; margin:0px; max-width:100%; max-height:none; width:" + e + "px; height:" + d + "px;' src='" + a.elemArray[this.data][1] + "' /></div>" + h + "</div><div class='html5gallery-tn-title-" +
                            a.id + "'>" + a.elemArray[this.data][7] + (a.options.thumbshowdescription ? "<br /><span class='html5gallery-tn-description-" + a.id + "'>" + a.elemArray[this.data][8] + "</span>" : "") + "</div>");
            ...
            goFullscreen: function () {
                ...
                var f = Math.max(e, b(document).height()),
                    ...
                    l = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18],
            ...
            slideRun: function (a, c, d, e) {
                ...
                if (this.options.showtitle || this.options.lightboxshowtitle || this.options.lightboxshowdescription) {
                    ...
                    } else this.options.showtitle && (j = "", a && (j += "<div class='html5gallery-title-text-" + this.id + "'>" + a + "</div>"), this.options.showdescription &&
                        f && (j += "<div class='html5gallery-description-text-" + this.id + "'>" + f + "</div>"), b(".html5gallery-title-" + this.id, this.$gallery).html(j));
            ...
            showImage: function () {
                ...
                b(d).on("load", function () {
                    ...
                    e = b("<div class='html5gallery-elem-img-" + c.id + "' style='display:block; position:absolute; overflow:hidden; width:" + j + "px; height:" + l + "px; left:0px; margin-left:" + (c.options.slideshadow && !c.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (c.options.slideshadow && !c.isFullscreen ?
                        4 : 0) + "px;'><img alt='" + c.html2Text(c.elemArray[c.curElem][25]) + "'" + (c.options.addimgtitle ? " title='" + c.html2Text(c.elemArray[c.curElem][7]) + "'" : "") + " class='html5gallery-elem-image-" + c.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + g + "px; top:" + k + "px; max-width:none; max-height:none; width:" + e + "px; height:" + d + "px;' src='" + c.elemArray[c.curElem][2] + "' />" + c.options.watermarkcode + "</div>");
                    d = b(".html5gallery-elem-img-" + c.id, a);
                    d.length ?
                        (a.prepend(e), a.html5boxTransition(c.id, d, e, {
            ...
            showPoster: function () {
                ...
                b(j).on("load", function () {
                    ...
                    g = b("<div class='html5gallery-elem-img-" + d.id + "' style='display:block; position:absolute; overflow:hidden; width:" + g + "px; height:" + k + "px; left:0px; margin-left:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px;'><img alt='" + d.html2Text(d.elemArray[d.curElem][25]) +
                        "'" + (d.options.addimgtitle ? " title='" + d.html2Text(d.elemArray[d.curElem][7]) + "'" : "") + " class='html5gallery-elem-image-" + d.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + n + "px; top:" + s + "px; max-width:none; max-height:none; width:" + m + "px; height:" + j + "px;' src='" + d.elemArray[d.curElem][12] + "' />" + d.options.watermarkcode + "</div>");
                    ...
                    if (!b(".html5gallery-video-play-" + d.id, a).length) b("<div class='html5gallery-video-play-" + d.id + "' style='position:absolute;display:block;cursor:pointer;top:50%;left:50%;width:64px;height:64px;margin-left:-32px;margin-top:-32px;background:url(\"" + d.options.playvideoimage + "\") no-repeat center center;'></div>").appendTo(c).off(d.eClick).on(d.eClick, function () {
                        d.options.hidetitlewhenvideoisplaying &&
                            b(".html5gallery-title-" + d.id, d.$gallery).hide();
                        b(this).remove();
                ...
                b(j).on("error", function () {
                    ...
                    c.html("<div class='html5gallery-elem-error-" +
                        d.id + "' style='display:block; position:absolute; overflow:hidden; text-align:center; width:" + d.options.width + "px; left:0px; top:" + Math.round(d.options.height / 2 - 10) + "px; margin:4px;'><div class='html5gallery-error-" + d.id + "'>The requested content cannot be found</div>");
            ...
            showYoutube: function (a) {
                ...
                b(".html5gallery-elem-" + this.id, c).html("<div class='html5gallery-loading-center-" + this.id +
                    "'></div><div id='html5gallery-elem-video-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + e + "px;height:" + d + "px;'></div>" + this.options.watermarkcode);
            ...
            showVimeo: function (a) {
                ...
                b(".html5gallery-elem-video-" + this.id, d).html("<iframe id='html5gallery_vimeo_" + this.id + "' width='" + f + "' height='" + e + "' src='" + j + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
            ...
            embedHTML5Video: function (a, c, d, e, f, j, l, g) {
                ...
                a.html("<div class='html5gallery-elem-video-container-" + this.id + "' style='position:relative;display:block;background-color:#000;width:100%;height:100%;'><video id='html5gallery-elem-html5-video-" + this.id + "' width='100%' height='100%'" + (this.options.nativehtml5controls &&
                    !this.options.videohidecontrols ? " controls" : "") + (this.options.html5videonodownload ? ' controlsList="nodownload"' : "") + "></div>");
                b("video", a).get(0).setAttribute("src", (f && this.isHd ? f : e) + (0 < l ? "#t=" + l : ""));
                !this.options.nativehtml5controls && !this.options.videohidecontrols && (b("video", a).data("src", e), b("video", a).data("hd", f), b("video", a).data("ishd", this.isHd), b("video", a).addHTML5VideoControls(this.options.skinfolder, this, "#html5gallery-elem-html5-video-" + this.id, !1, !1, this.options.defaultvideovolume,
                    this.options.fullscreennativecontrols, this.options.html5videonodownload, null));
            ...
            embedFlash: function (a,
                ...
                } else a.html("<div class='html5gallery-elem-error-" + this.id + "' style='display:block; position:absolute; text-align:center; width:" +
        ...
        this.each(function () {
            ...
            if ((!b(this).data("donotinit") || k && k.forceinit) && !b(this).data("inited")) {
                ...
                var h = {
                    ...
                    z = "vertical" == this.options.skin ? b.extend(z, t) : "verticallight" == this.options.skin ? b.extend(z, s) : "showcase" == this.options.skin ? b.extend(z, x) : "light" == this.options.skin ? b.extend(z, h) : "gallery" == this.options.skin ? b.extend(z, j) : "gallerywithtext" == this.options.skin ? b.extend(z, l) : "gallerywithtopthumbs" == this.options.skin ?
                    b.extend(z, g) : "gallerywithtextbottom" == this.options.skin ? b.extend(z, m) : "horizontal" == this.options.skin ? b.extend(z, c) : "darkness" == this.options.skin ? b.extend(z, n) : "mediapage" == this.options.skin ? b.extend(z, f) : b.extend(z, c);
                ...
                for (c = 0; c < h.length; c++) this.options[h[c]] && (0 < this.options[h[c]].length && "http://" !=
                    this.options[h[c]].substring(0, 7).toLowerCase() && "https://" != this.options[h[c]].substring(0, 8).toLowerCase()) && (this.options[h[c]] = this.options.skinfolder + this.options[h[c]]);
                h = "";
                ...
                if (this.options.screenquery)
                    for (c in this.options.screenquery) h <=
                        this.options.screenquery[c].screenwidth && (this.options.screenquery[c].gallerywidth && (this.options.width = this.options.screenquery[c].gallerywidth), this.options.screenquery[c].galleryheight && (this.options.height = this.options.screenquery[c].galleryheight), this.options.screenquery[c].thumbwidth && (this.options.thumbwidth = this.options.screenquery[c].thumbwidth), this.options.screenquery[c].thumbheight && (this.options.thumbheight = this.options.screenquery[c].thumbheight));
                "galleryid" in this.options ? c = this.options.galleryid :
                    (c = F, F++);
...
function HTML5GallerySWFObjectFunc() {
    ...
    function A(a, c, d, j) {
        ...
        if (h) {
            ...
            p.ie && (p.win && 4 != h.readyState) && (j = r.createElement("div"), d += "SWFObjectNew", j.setAttribute("id", d), h.parentNode.insertBefore(j, h), h.style.display = "none", function () {
    ...
    function F(a, b, c) {
        ...
        if (g)
            if (typeof a.id == f && (a.id = c), p.ie && p.win) {
                ...
                for (h in b) b[h] != Object.prototype[h] && "movie" != h.toLowerCase() && (a = m, k = h, n = b[h], c = r.createElement("param"), c.setAttribute("name", k), c.setAttribute("value", n), a.appendChild(c));
    ...
    function c(a, b, c, d) {
        if (!p.ie || !p.mac) {
            ...
            if (e) {
                ...
                d && (J = v = null);
                if (!v ||
                    J != c) d = r.createElement("style"), d.setAttribute("type", "text/css"), d.setAttribute("media", c), v = e.appendChild(d), p.ie && (p.win && typeof r.styleSheets != f && 0 < r.styleSheets.length) && (v = r.styleSheets[r.styleSheets.length - 1]), J = c;
                p.ie && p.win ? v && typeof v.addRule == j && v.addRule(a, b) : v && typeof r.createTextNode != f && v.appendChild(r.createTextNode(a + " {" + b + "}"))
            }
        }
    }
    ...
    var f = "undefined",
        ...
        E = !1,
        v, J, L = !0,
        p, U = typeof r.getElementById != f && typeof r.getElementsByTagName != f && typeof r.createElement != f,
    ...
    p.w3 && ((typeof r.readyState != f && "complete" == r.readyState || typeof r.readyState == f && (r.getElementsByTagName("body")[0] || r.body)) && u(), B || (typeof r.addEventListener != f && r.addEventListener("DOMContentLoaded", u, !1), p.ie && p.win && (r.attachEvent("onreadystatechange", function () {
        "complete" == r.readyState && (r.detachEvent("onreadystatechange", arguments.callee), u())
    }), w == top && function () {
        if (!B) {
            try {
        ...
        B || (/loaded|complete/.test(r.readyState) ? u() : setTimeout(arguments.callee, 0))
    }(), m(u)));
    ...
    return {
        ...
        expressInstallCallback: function () {
            if (E) {
                var a = e(g);
                a && D && (a.parentNode.replaceChild(D, a), T && (d(T, !0), p.ie && p.win && (D.style.display = "block")), X && X(q));
                E = !1
            }
        }
    }
